def format_order_insert_info(xid, order_insert_info):
    return (
        "Order insert info: xid={}, order_client_id={}, security_code={}, "
        "exchange_id={}, price={}, quantity={}, order_price_type={}, side={}, business_type={}".format(
            xid,
...
def format_order_cancel_info(xid, order_cancel_info):
    return "Order cancel info: xid={}, order_client_id={}, origin_xid={}".format(
        xid,  # 撤单委托ID
...
def format_order_response(order_response):
    return (
        "Order response: report_id={}, xid={}, order_client_id={}, orig_xid={}, orig_order_client_id={}, "
...
def format_order_reject(order_reject):
    return (
        "Order reject: report_id={}, xid={}, order_client_id={}, orig_xid={}, orig_order_client_id={}, "
        "security_code={}, exchange_index={}, business_type={}, side={}, price={}, quantity={},"
        "order_price_type={}, error_id={}, error_msg={}".format(
...
def format_order_cancel_fail(order_cancel_fail):
    return (
        "Order cancel fail: report_id={}, xid={}, order_client_id={}, orig_xid={}, "
...
def format_trade_report(trade_report):
    return (
        "Trade report: report_id={}, xid={}, order_client_id={}, security_code={}, "
        "exchange_index={}, business_type={}, side={}, exec_id={}, exec_type={}, order_status={}, "
        "price={}, quantity={}, leaves_qty={}, report_time={}".format(
...
def format_position(position):
    return (
        "Position: security_code={}, security_name={}, exchange_index={}, total_qty={}, "
        ...
        "last_buy_cost={}, last_profit_cost={}".format(
...
def format_asset(asset):
    return (
        "Asset: total_asset={}, buying_power={}, initial_buying_power={}, "
        "security_asset={}, fund_buy_amount={}, fund_buy_fee={}, "
        "fund_sell_amount={}, fund_sell_fee={}, withholding_amount={}".format(
...
def format_order(order):
    return (
        "Order xid: {}, order_client_id: {}, cancel_xid: {}, cancel_order_client_id: {}, "
        ...
        "order_status: {}, order_exch_id: {}, error_id: {}, error_msg: {}".format(
            order.xid,  # 报单标识
