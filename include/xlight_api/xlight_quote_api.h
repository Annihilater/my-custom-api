...
public:
     ...
     * @return 初始化是否成功
     */
    virtual bool initialize(xlight::api::xlt_quote_config_t *config) = 0;
     ...
     */
    virtual void register_spi(xlight::api::QuoteSpi *spi) = 0 ;
     ...
     */
    virtual void subscribe(char (*security_code)[XLT_SECURITY_CODE_LEN], int count, XLTExchangeType exchange_index) = 0;
     ...
     * @param exchange_index 交易所代码
     */
    virtual void unsubscribe(char (*security_code)[XLT_SECURITY_CODE_LEN], int count, XLTExchangeType exchange_index)
    = 0;
